...
public interface PlateauJeu {
     ...
     */
    public abstract ArrayList<CoupJeu> coupsPossibles(String j);
     ...
     */
    public abstract void joue(String j, CoupJeu c);
     ...
     */
    public abstract boolean coupValide(String j, CoupJeu c);
